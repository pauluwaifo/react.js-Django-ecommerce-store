...
class Product(models.Model):
    ...
    image = models.ImageField(null=True, blank=True, default='/small.png')
    image2 = models.ImageField(null=True, blank=True, default='/small.png')
...
class ShippingAddress(models.Model):
    ...
    shippingPrice = models.DecimalField(max_digits=700, decimal_places=2, null=True, blank=True)
    _id = models.AutoField(primary_key=True, editable=False)  
